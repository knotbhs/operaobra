...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><a href="{{ route('empresas') }}">Painel</a> > <a href="{{ route('empresas.painel', [$empresa['id']]) }}">{{ $empresa['name'] }}</a> > <a href="{{ route('empresas.servico', [$empresa['id'], $orcamento['id']]) }}">{{ $cliente->name }}</a> > <a href="{{ route('empresas.servico.edit', [$empresa['id'], $orcamento['id']]) }}" class="text-dark">Editando Serviço</a></div>
                <div class="card-body">                    
    ...
    <script>
        ...
        function editarItem(request)
        {
            ...
            $(items).each(function(){
                ...
                if(name == 'valor')
                {
                    $("input#valor").val(text.toString().replace("R$ ", ""));
                }else if(name == 'name')
                {
